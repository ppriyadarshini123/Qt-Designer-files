...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(140, 30, 231, 241))
        self.label.setText("")
        ...
        self.cat.setGeometry(QtCore.QRect(70, 300, 75, 23))
        self.cat.setObjectName("cat")

        self.dog = QtWidgets.QPushButton(self.centralwidget)
        self.dog.setGeometry(QtCore.QRect(370, 300, 75, 23))
    ...
    def show_dog(self):
        self.label.setPixmap(QtGui.QPixmap("dog.png"))
    def show_cat(self):
        self.label.setPixmap(QtGui.QPixmap("cat.png"))
